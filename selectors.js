...
var EditRouteSelectors =
{
	...
	'sector_lengths' : x("//div[contains(text(),'Total scheduled flight time:')]/following-sibling::div[1]"),
	
	'outbound_dep_HH'	: '#Dep1H',
	'outbound_dep_MM'	: '#Dep1M',
	'outbound_arr_tm'	: x("(//td[contains(text(),'Arrival time (local)')]/following-sibling::td)[1]"),
	'outbound_flt_tm'	: x("(//td[contains(text(),'Flight Time')]/following-sibling::td)[1]"),
	'inbound_dep_tm'	: x("(//td[contains(text(),'Departure time (local)')]/following-sibling::td)[2]"),
	'inbound_arr_tm'	: x("(//td[contains(text(),'Arrival time (local)')]/following-sibling::td)[2]"),
	'inbound_flt_tm'    : x("(//td[contains(text(),'Flight Time')]/following-sibling::td)[2]"),
	...
	'distance'	: x('//*[@id="routeEditorArea"]/div[1]/div[2]/table/thead/tr[1]/td/table/thead/tr[1]/td[3]'),
	'fleetCode'	: '#FleetID',
	'flightNumber'	: '#Number',
	...
	'PriceReset'	: x('//*[@id="routeEditorArea"]/div[1]/div[2]/table/thead/tr[12]/td[2]/div[1]/a[3]'),
	/*
	'base'		: '#routeEditorArea > div.borderOuter > div.borderInner.smallDataBox > table > thead > tr:nth-child(1) > td > table > thead > tr:nth-child(1) > td.Bg > span > a',
